...
namespace SSoft.IoT.MVC.Controllers
{
    public class GestionController : Controller
    {
        ...
        public JsonResult ObtenerIndicadorLectura(string fecha)
        {
            if ((string)Session["CodigoMensaje"] != "Ok" || Session["CodigoMensaje"] == null)
            {
                Response.Redirect("../Index/Index");
            ...
            //    dia = day;
            //}
            var re = _servicioCultivoOnline.ObtenerIndicadorLectura(usuarioId, dia, mes, anio);
        ...
        public ActionResult ObtenerConfiguraciones(string sidx, string sord, int page, int rows,
                bool _search, string searchField, string searchOper, string searchString, int idMaquina)
        {
            if ((string)Session["CodigoMensaje"] != "Ok" || Session["CodigoMensaje"] == null)
            {
                Response.Redirect("../Index/Index");
            ...
            gridRows = _servicioCultivoOnline.ObtenerConfiguracionesVigentes(idMaquina);
                ...
                bool _search, string searchField, string searchOper, string searchString)
        {
            ...
            var data = (from s in sortedgridRows
                        ...
                        {
                            id = s.Id,
                            cell = new object[] { s.Id, s.Nombre, s.NombreTarea, s.FechaAccion, s.Accion, s.LitrosMin }
                        }).ToArray();
